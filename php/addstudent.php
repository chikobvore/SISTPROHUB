...
if (isset($_POST['name']) && isset($_POST['surname']) && isset($_POST['reg_number']) &&  isset($_POST['physical_address']) && isset($_POST['email']) && isset($_POST['phone']) && isset($_POST['dob']) && isset($_POST['Gender']) && isset($_POST['program']))
          ...
          $sql = "INSERT INTO students (Name,Surname,Reg_number,Program,Department,Email_address,Physical_address,Contact,Gender,Date_of_birth,Status) VALUES('$name','$surname','$reg_number','$program','$Department','$email','$paddress','$phone','$Gender','$dob','OFFLINE')";
